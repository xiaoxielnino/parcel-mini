...
const prelude = fs.readFileSync(__dirname + '/../builtins/prelude.js', 'utf-8').trim();
const hmr = fs.readFileSync(__dirname + '/../builtins/hmr-runtime.js', 'utf-8').trim();
class JSPackager extends Packager {
  ...
  async addAsset(asset) {
    ...
    for(let dep of asset.dependencies.values()) {
      let mode = asset.depAssets.get(dep.name);
